...
class Driver:
    ...
    def load_cost(self, load: Load) -> float:
        ...
        return_to_depot = math.sqrt(self.distance_from_depot_squared())
...
if __name__ == '__main__':
    ...
    while True:
        ...
        # Sort dict
        load_costs = dict(sorted(load_costs.items()))
        ...
        if len(load_costs) == 0:
            ...
            # Take cheapest job
            chosen_load = list(load_costs.values())[0]
    ...
    # print(f"Total cost: {500 * len(drivers) + minutes_sum}")
